...
def main():
    ...
    for i in range(16):
        ...
        # Calculate the top 5 highest and lowest node degrees
        ...
        # Calculate the sum of in-degrees and out-degrees of all nodes 
        sum_of_in_degrees = sum(in_degrees)
        sum_of_out_degrees = sum(out_degrees)

        # Create a copy of the analysis_results dictionary for modification
        analysis_results = {
